              ...
              return (
                <div
                  ...
                  className={`w-full snap-center shrink-0 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-2xl p-6 md:p-8 animate-fade-in-up shadow-sm relative overflow-hidden flex flex-col ${
                    isPensamiento
                      ? "text-center border-blue-200 dark:border-blue-700"
                      : ""
                  }`}
                >
                  <div className="mb-8 relative z-10 group">
                    {msg.recipientLabel && (
                      <div
                        className={`mb-3 text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider flex items-center gap-1 ${isPensamiento ? "justify-center" : ""}`}
                      >
                        <span>Para:</span>
                    ...
                    {!isError && !msg.isStreaming && onRegenerate && (
                      <div className="mt-3">
                        <button
                          ...
                          className="text-[10px] font-bold text-slate-500 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 flex items-center gap-1 transition-colors"
                    ...
                    {!isError && (
                      <button
                        ...
                        className="absolute top-0 right-0 p-2 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm rounded-lg text-slate-500 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 opacity-0 group-hover:opacity-100 transition-all shadow-sm border border-slate-100 dark:border-slate-700"
                        ...
                        <button
                          ...
                          className={`w-12 h-12 rounded-xl flex items-center justify-center transition-all ${
                            isFav
                              ...
                              : "bg-slate-50 dark:bg-slate-800 text-slate-500 dark:text-slate-400 hover:text-red-400"
                    ...
                    {!isPensamiento && (
                      <div className="mt-6 flex flex-col gap-1 w-full text-left">
                        ...
                        <p className="text-[10px] text-slate-500 dark:text-slate-400 leading-tight">
                          Tú decides cómo usar este mensaje. No somos
                          responsables de las consecuencias sociales de su
                          envío.
                        </p>
                      </div>
                    )}
      ...
      {messages.length > 0 && onClearHistory && (
        <div className="flex justify-center mt-8 pt-4 border-t border-slate-100 dark:border-slate-800 animate-fade-in">
          <button
            ...
            className="text-sm font-bold text-slate-500 dark:text-slate-400 hover:text-red-500 dark:hover:text-red-400 transition-colors flex items-center gap-2 px-4 py-2 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-800"
          >
