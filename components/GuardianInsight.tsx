      ...
      <div className="relative z-10">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-3">
          <div className="flex items-center gap-3">
            <div className="text-2xl bg-white dark:bg-slate-800 p-2 rounded-lg shadow-sm shrink-0">
              {isPremium ? "🦁" : "🔮"}
            </div>
          ...
          {!isPremium && (
            <Link
              to="/pricing"
              className="flex items-center justify-center sm:justify-start gap-1 text-[10px] font-bold text-indigo-600 dark:text-indigo-300 bg-indigo-100 dark:bg-indigo-900/40 px-3 py-1.5 rounded-full border border-indigo-200 dark:border-indigo-800 hover:bg-indigo-200 dark:hover:bg-indigo-900/60 transition-colors w-full sm:w-auto whitespace-nowrap"
            >
