...
const MagicWandIcon = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    <path d="M16.5 2L15.5 4.5L13 5.5L15.5 6.5L16.5 9L17.5 6.5L20 5.5L17.5 4.5L16.5 2Z" fill="white"/>
    <path d="M6 3L5.25 4.75L3.5 5.5L5.25 6.25L6 8L6.75 6.25L8.5 5.5L6.75 4.75L6 3Z" fill="white" fillOpacity="0.8"/>
    <path d="M19.5 14L18.75 15.75L17 16.5L18.75 17.25L19.5 19L20.25 17.25L22 16.5L20.25 15.75L19.5 14Z" fill="white" fillOpacity="0.9"/>
    <path d="M4 21L14.5 10.5M14.5 10.5L16.5 8.5C17.0523 7.94772 17.0523 7.05228 16.5 6.5C15.9477 5.94772 15.0523 5.94772 14.5 6.5L12.5 8.5M14.5 10.5L12.5 8.5" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);
      ...
      <header className="bg-white/90 backdrop-blur-xl border-b border-slate-100 sticky top-0 z-50 shadow-sm transition-all duration-300">
        <div className="max-w-screen-2xl mx-auto">
          ...
          <div className="px-4 sm:px-6 lg:px-8 flex h-16 md:h-20 items-center justify-between">
            <Link to="/" className="flex items-center gap-2.5 shrink-0 focus-visible:outline-none group" aria-label={`Ir al inicio de ${siteName}`}>
        ...
        <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
            <div className="md:col-span-5">
              ...
              <p className="text-slate-500 max-w-sm text-sm leading-relaxed mb-8 font-medium">
                Plataforma impulsada por IA para crear conexiones significativas a través de las palabras. 
              </p>
              
              <div className="inline-flex flex-col gap-3">
                <span className="text-[10px] font-bold uppercase tracking-[0.15em] text-slate-400">Selecciona tu Región</span>
            ...
            <div className="grid grid-cols-2 md:col-span-7 gap-8">
              <div>
                <h3 className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 mb-8">Categorías</h3>
                <ul className="space-y-4 text-sm font-semibold">
                  {OCCASIONS.slice(0, 4).map(o => {
                    const localized = getLocalizedOccasion(o, currentCountry);
                    return (
                      <li key={o.id}>
                        <Link to={`/mensajes/${o.slug}`} className="text-slate-600 hover:text-blue-600 transition-colors inline-flex items-center gap-2">
              ...
              <div>
                <h3 className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 mb-8">Institucional</h3>
                <ul className="space-y-4 text-sm font-semibold">
                  <li><Link to="/privacidad" className="text-slate-600 hover:text-blue-600 transition-colors">Aviso de Privacidad</Link></li>
                  <li><Link to="/terminos" className="text-slate-600 hover:text-blue-600 transition-colors">Términos de Uso</Link></li>
                  <li><Link to="/contacto" className="text-slate-600 hover:text-blue-600 transition-colors">Centro de Contacto</Link></li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="mt-16 pt-8 border-t border-slate-50 flex flex-col md:flex-row justify-between items-center gap-6">
            <p className="text-xs text-slate-400 font-bold tracking-tight">
              &copy; {new Date().getFullYear()} {siteName}. Diseñado con ❤️ para el mundo.
            </p>
          </div>
        </div>
      </footer>
