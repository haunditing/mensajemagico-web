...
const MetricsDisplay: React.FC = () => {
  ...
  return (
    <div className="flex flex-wrap items-center justify-center gap-x-8 gap-y-2 py-4 px-6 border-t border-slate-100 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-900/50">
