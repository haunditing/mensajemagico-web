...
export const SAFETY_ERROR_MESSAGE = "Tu mensaje contiene términos que no cumplen con nuestras políticas de respeto. Por favor, utiliza un lenguaje cordial para generar tu respuesta.";
