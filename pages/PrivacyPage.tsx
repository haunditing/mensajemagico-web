  ...
  return (
    <div className="max-w-4xl mx-auto py-12 px-4 animate-fade-in-up">
      <div className="text-center mb-16">
        ...
        <p className="text-slate-500 dark:text-slate-400 font-medium">Última actualización: 10 de febrero de 2026</p>
      </div>

      <div className="bg-blue-600 dark:bg-blue-700 rounded-[2.5rem] p-8 md:p-10 text-white mb-12 shadow-xl shadow-blue-500/20 dark:shadow-none relative overflow-hidden">
      ...
      <div className="space-y-8 prose prose-slate dark:prose-invert max-w-none">
        <section className="bg-white dark:bg-slate-900 p-8 rounded-[2rem] border border-slate-100 dark:border-slate-800 shadow-sm">
          <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-0 flex items-center gap-3">
            <span className="text-blue-500 dark:text-blue-400">01.</span> Datos que Recopilamos
          </h2>
        ...
        <section className="bg-white dark:bg-slate-900 p-8 rounded-[2rem] border border-slate-100 dark:border-slate-800 shadow-sm">
          <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-0 flex items-center gap-3">
            <span className="text-blue-500 dark:text-blue-400">02.</span> Inteligencia Artificial y Aprendizaje
          </h2>
          <p className="text-slate-600 dark:text-slate-300">
        ...
        <section className="bg-white dark:bg-slate-900 p-8 rounded-[2rem] border border-slate-100 dark:border-slate-800 shadow-sm">
          <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-0 flex items-center gap-3">
            <span className="text-blue-500 dark:text-blue-400">03.</span> Cookies y Terceros
          </h2>
          <p className="text-slate-600 dark:text-slate-300">
        ...
        <section className="bg-white dark:bg-slate-900 p-8 rounded-[2rem] border border-slate-100 dark:border-slate-800 shadow-sm">
          <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-0 flex items-center gap-3">
            <span className="text-blue-500 dark:text-blue-400">04.</span> Tus Derechos
          </h2>
          <p className="text-slate-600 dark:text-slate-300">
