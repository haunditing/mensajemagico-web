...
export const CONFIG = {
  ...
  ADSENSE: {
    IS_ACTIVE: isTruthy(getEnv('ADSENSE_ACTIVE', 'false')) || window.location.search.includes('ads=true'),
    CLIENT_ID: getEnv('ADSENSE_CLIENT_ID', "ca-pub-0000000000000000"),
    DEBUG_MODE: process.env.NODE_ENV === 'development' || window.location.search.includes('debug=true'),
    SLOTS: {
  ...
  SEO: {
    ...
    DEFAULT_DESC: getEnv('SEO_DEFAULT_DESC', "IA generadora de cartas e inspiración para momentos especiales."),
  },
